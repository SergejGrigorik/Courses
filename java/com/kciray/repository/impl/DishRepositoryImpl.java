...
import com.kciray.repository.DishDao;
...
public class DishRepositoryImpl extends RepositoryBase<Integer, Dish> implements DishDao {
    ...
    public List<Dish> findAllDishByRestaurantIdAndCategoryById(Integer restaurantId, Integer categoryId) {
        ...
        restaurantRoot.join(Dish_.category);
