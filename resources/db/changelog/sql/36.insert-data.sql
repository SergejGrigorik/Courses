...
insert into "user" (profile_id, password, login, role_id)
...
insert into user_card (payment_card_id, user_id)
values (1,1),
       (2,2),
       (3,3);

insert into restaurant_operator (restaurant_id, user_id)
values (1,4),
       (2,5),
       (3,6);

insert into courier (profile_id, location_coordinates_courier, courier_status)
values (7,'123x123','BUSY'),
       (8,'321x321','BUSY'),
       (9,'432x432','BUSY');

insert into schedule_courier (courier_id, working_hours_from, working_hours_to, "day")
...
values ('Margarita',1,1,30,1000,1,'tender pizza'),
       ...
       ('Fettuccine',3,3,32,400,6,'thick noodles, 7 mm wide, similar to tagliatelle, the friability of which allows them to go well with all sorts of sauces and ingredients');
