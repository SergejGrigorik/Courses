...
public class UserDtoUpRequest {
    @Schema(description = "UserName", example = "Jonatan")
    ...
    @Size(min = 5, max = 255, message =
            "Email address must be between 5 and 255 characters")
    @NotBlank(message =
            "Email address cannot be empty")
    @Email(message =
            "Email address must be in the format user@example.com")
